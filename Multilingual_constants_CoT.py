...
LANG_CONFIG = {
    "en": {"answer": "Answer the following question:", "steps": "### INSTRUCTIONS:\nSolve the problem step-by-step:\n1. Identify {target_world}.\n2. State the formula.\n3. Substitute.\n4. Calculate.\n5. Final result.\n\n### OUTPUT FORMAT:\nReasoning: [steps]\nThe final answer is: [number]"},
    "zh": {"answer": "请回答以下问题：", "steps": "### 指示：\n1. 确定 {target_world}。\n2. 写公式。\n3. 代入。\n4. 计算。\n5. 给出结果。\n\n推理: [步骤]\n最终答案是: [数字]"},
    "el": {"answer": "Απαντήστε στην ακόλουθη ερώτηση:", "steps": "### ΟΔΗΓΙΕΣ:\n1. Βρείτε {target_world}.\n2. Δηλώστε τύπο.\n3. Αντικατάσταση.\n4. Υπολογισμός.\n5. Τελικό αποτέλεσμα.\n\nΣυλλογιστική: [βήματα]\nΗ τελική απάντηση είναι: [αριθμός]"},
    "tr": {"answer": "Aşağıdaki soruyu cevaplayın:", "steps": "### TALİMATLAR:\n1. {target_world} bulun.\n2. Formül yazın.\n3. Yerine koyun.\n4. Hesaplayın.\n5. Sonuç.\n\nAkıl Yürütme: [adımlar]\nSon cevap: [sayı]"},
    "sw": {"answer": "Jibu swali lifuatalo:", "steps": "### MAELEKEZO:\n1. Tambua {target_world}.\n2. Andika fomula.\n3. Weka.\n4. Hesabu.\n5. Jibu.\n\nHoja: [hatua]\nJibu la mwisho ni: [nambari]"},
    "ka": {"answer": "უპასუხეთ შემდეგ კითხვას:", "steps": "### ინსტრუქციები:\n1. იპოვეთ {target_world}.\n2. ჩაწერეთ ფორმულა.\n3. ჩასვით.\n4. გამოთვალეთ.\n5. შედეგი.\n\nმსჯელობა: [ეტაპები]\nსაბოლოო პასუხია: [რიცხვი]"}
}

def build_prompt(worldA_text, worldB_text, question, target_world, lang):
    cfg = LANG_CONFIG[lang]
    steps_filled = cfg["steps"].format(target_world=target_world)
...
for level_num, df in levels.items():
    ...
    for variant_name, config in variants.items():
        ...
        output_csv = os.path.join(output_dir, f"qwen72_lang_constants_CoT_{level_num}{variant_name}.csv")
