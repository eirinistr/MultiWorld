...
LANG_CONFIG = {
    "en": {"answer": "Answer the following question:", "instruction": "DO NOT add any explanation.", "return_line": "Return ONLY one line.", "format": "OUTPUT FORMAT:", "final": "The final answer is: <number>", "examples": ["WorldA: The value of pi is 10\nWorldB: The value of pi is 3\nQuestion: pi * 2 in WorldA\nThe final answer is: 20", "WorldA: The value of c is 50\nWorldB: The value of c is -10\nQuestion: c * 3 in WorldB\nThe final answer is: -30"]},
    "zh": {"answer": "请回答以下问题：", "instruction": "不要添加任何解释。", "return_line": "只返回一行。", "format": "输出格式：", "final": "最终答案是： <一个数字>", "examples": ["WorldA: pi 的值是 10\nWorldB: pi 的值是 3\n问题: pi * 2 在 WorldA\n最终答案是: 20", "WorldA: c 的值是 50\nWorldB: c 的值是 -10\n问题: c * 3 在 WorldB\n最终答案是: -30"]},
    "el": {"answer": "Απαντήστε στην ακόλουθη ερώτηση:", "instruction": "ΜΗΝ προσθέσετε καμία εξήγηση.", "return_line": "Επιστρέψτε ΜΟΝΟ μία γραμμή.", "format": "ΜΟΡΦΗ ΕΞΟΔΟΥ:", "final": "Η τελική απάντηση είναι: <ένας αριθμός>", "examples": ["WorldA: Η τιμή του pi είναι 10\nWorldB: Η τιμή του pi είναι 3\nΕρώτηση: pi * 2 στο WorldA\nΗ τελική απάντηση είναι: 20", "WorldA: Η τιμή του c είναι 50\nWorldB: Η τιμή του c είναι -10\nΕρώτηση: c * 3 στο WorldB\nΗ τελική απάντηση είναι: -30"]},
    "tr": {"answer": "Aşağıdaki soruyu cevaplayın:", "instruction": "Herhangi bir açıklama eklemeyin.", "return_line": "SADECE tek satır döndürün.", "format": "ÇIKTI FORMATI:", "final": "Son cevap: <bir sayı>", "examples": ["WorldA: pi değeri 10\nWorldB: pi değeri 3\nSoru: pi * 2 WorldA'da\nSon cevap: 20", "WorldA: c değeri 50\nWorldB: c değeri -10\nSoru: c * 3 WorldB'de\nSon cevap: -30"]},
    "sw": {"answer": "Jibu swali lifuatalo:", "instruction": "Usiongeze maelezo yoyote.", "return_line": "Rudisha mstari mmoja TU.", "format": "MUUNDO WA MATOKEO:", "final": "Jibu la mwisho ni: <nambari>", "examples": ["WorldA: Thamani ya pi ni 10\nWorldB: Thamani ya pi ni 3\nSwali: pi * 2 katika WorldA\nJibu la mwisho ni: 20", "WorldA: Thamani ya c ni 50\nWorldB: Thamani ya c ni -10\nSwali: c * 3 katika WorldB\nJibu la mwisho ni: -30"]},
    "ka": {"answer": "უპასუხეთ შემდეგ კითხვას:", "instruction": "არ დაამატოთ ახსნა.", "return_line": "დააბრუნეთ მხოლოდ ერთი ხაზი.", "format": "გამოტანის ფორმატი:", "final": "საბოლოო პასუხია: <რიცხვი>", "examples": ["WorldA: pi-ის მნიშვნელობა არის 10\nWorldB: pi-ის მნიშვნელობა არის 3\nკითხვა: pi * 2 WorldA-ში\nსაბოლოო პასუხია: 20", "WorldA: c-ის მნიშვნელობა არის 50\nWorldB: c-ის მნიშვნელობა არის -10\nკითხვა: c * 3 WorldB-ში\nსაბოლოო პასუხია: -30"]}
}
...
for level_num, df in levels.items():
    ...
    for variant_name, config in variants.items():
        ...
        output_csv = os.path.join(output_dir, f"qwen72_lang_constants_fs_prompt1_{level_num}{variant_name}.csv")
